...
```
*NOTE
If you are looking for the sdk written in Swift 4, use this snippet in the `Podfile`:
```ruby
...
```ruby
pod 'Survata', :git => 'git@github.com:Survata/survata-ios-public-sdk.git', :branch => 'swift-2.3'
```
